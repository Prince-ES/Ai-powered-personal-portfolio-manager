    ...
    return (
        <div className="rightPart w-1/2  max-lg:min-w-screen flex items-center justify-center bg-taupe-50 p-8">
                <form className="flex flex-col items-left justify-center bg-gray-400 px-8 py-12  rounded-[20px] shadow-lg" required>
                   {isSignup && <input type="text" placeholder="Name" className="w-[350px] border-1 rounded-[10px] border-black-300 focus:outline-none h-[50px]  bg-gray-50 p-4" />}

                    <input type="text" placeholder="Email" className="w-[350px] border-1 rounded-[10px] border-black-300 focus:outline-none h-[50px]  bg-gray-50 p-4 mt-4" />
                    
                    <input type="password" placeholder="Password" className="w-[350px] border border-black-300 focus:outline-none bg-gray-50 p-4 rounded-[10px] mt-4 h-[50px]" />

                   {isSignup && <input type="password" placeholder="Confirm Password" className="w-[350px] border-1 rounded-[10px] border-black-300 focus:outline-none h-[50px]  bg-gray-50 p-4 mt-4" />}
