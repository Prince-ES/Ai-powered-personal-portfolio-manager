...
function AuthCard ({mode}){ 
    ...
    return (
        ...
        <form className="flex flex-col items-left justify-center bg-[#DDDDDD]  border-2 border-white px-8 py-12  rounded-[20px] shadow-2xl relative z-4" >
            ...
            <button className="w-[350px] bg-[#0C161D] text-white h-[45px] rounded-[10px]  mt-4 text-xl active:bg-gray-600">{isSignup ? "Sign up" : "Login"}</button>
